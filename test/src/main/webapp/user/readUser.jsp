...
$(function() {
	...
	$('td.ct_btn01:contains("확인")').on("click", function(){
		if(${(!empty param.isUpdate) && param.isUpdate.trim() =='clear'}){
...
<%-- 						<a href="/user/updateUser?userId=${vo.userId}">수정</a> --%>
					...
					<td>${param.isUpdate }</td>
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
<%-- 						<a href= "${(!empty param.isUpdate) && param.isUpdate.trim() =='clear' ? '/user/listUser' : 'javascript:history.go(-1);'}">확인</a> --%>
							확인
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
